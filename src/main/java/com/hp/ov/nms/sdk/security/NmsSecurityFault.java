...
@XmlType(name = "NmsSecurityFault", propOrder = {
    "message"
})
public class NmsSecurityFault implements Serializable {
     ...
     */
    public NmsSecurityFault(String message) {
