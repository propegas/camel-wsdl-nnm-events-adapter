...
public class StringArray implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":stringArray", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "stringArray", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static StringArray parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"stringArray".equals(type)) {
                            ...
                            return (StringArray) com.hp.ov.nms.sdk.filter.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
